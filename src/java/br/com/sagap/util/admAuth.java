...
@WebFilter(filterName = "admAuth", urlPatterns = {"/paginas/adm/*"})
public class admAuth implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if(pessoa==null){
            ...
            if(pessoa.getTipo()==1){
                ...
                if(pessoa.getTipo()==2){
                    res.sendRedirect(req.getContextPath()+"/paginas/user/index.xhtml");
                }else{
                    if(pessoa.getTipo()==0){
                        chain.doFilter(request, response);
